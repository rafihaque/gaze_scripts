...
class SubtractMean(object):
    ...
    def __init__(self, meanImg):
        meanImg = Image.fromarray(np.uint8(meanImg))
...
class ITrackerData(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # imEyeLPath = os.path.join(DATASET_PATH, '%05d/appleLeftEye_CV/%05d.jpg' % (self.metadata['labelRecNum'][index], self.metadata['frameIndex'][index]))
        ...
        #    faceGrid = self.makeGrid2(self.metadata['labelFaceGrid'][index,:])
        #else:
